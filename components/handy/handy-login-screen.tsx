...
export function HandyLoginScreen({
  ...
  return (
    <section
      ...
      className="fixed inset-0 z-40 flex flex-col overflow-y-auto bg-[#241436] px-7 pt-[max(16px,env(safe-area-inset-top))] pb-7 text-white"
    >
