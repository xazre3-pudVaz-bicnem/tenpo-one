  ...
  return (
    <form action={action} method="get" className="flex flex-wrap items-end gap-2">
      ...
      <div>
        ...
        <Input id="from" type="date" name="from" defaultValue={from} className="h-9 w-36 text-xs" />
      </div>
      <div>
        <Label htmlFor="to" className="text-xs">
          終了日
        </Label>
        <Input id="to" type="date" name="to" defaultValue={to} className="h-9 w-36 text-xs" />
      </div>
